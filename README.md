...
#### 94.2025-07-24
 1. 파이썬 - 기본 문법
    ...
    - list_dictionary
      - list : 순서대로 담아요 [{},{},{}]
      - tuple : 바뀌지 않는 생일달력 ()
      - dictionary : 이름표가 붙은 물건 { "":"" , "":"" }
      - set : 같은 것은 하나만! 중복x {"딸기","딸기","포도"} -> {"딸기","포도"}
    - fn_file
      - 함수
...
#### 93.2025-07-23
 ...
 2. 파이썬+장고
    ...
    - MVT 패턴
      ...
      - View - 템플릿에서 서버에 일시키기
    - 데이터베이스(ORM)
      - 기존에 생존하는 SQL을 쉽게 사용할 수 있게
      - 메서드로 만들어 놓고 호출해서 쓸수 있게
      - ORM에 정의 되어 있는 메서드 사용하기
...
---
#### 89.2025-06-28~2025-07-17
 1. 3차 팀프로젝트 - 기능 구현

---
#### 88.2025-06-27
 1. 3차 팀프로젝트 - 요구사항정의서(ERD, Figma 설계)

---
#### 87.2025-06-26
 1. 3차 팀프로젝트 - 요구사항정의서(기획)

---
#### 86.2025-06-25
 1. Spring + MyBatis - Board(Upload+Paging+Image)
    - 매퍼 설정
    - .mkdirs() - 디렉토리 생성
    - properties 세팅
 2. 3차 팀프로젝트
