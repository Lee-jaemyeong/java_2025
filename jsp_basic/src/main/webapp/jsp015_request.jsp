...
<body>
	...
	<div class="container card my-5">
		...
		<!-- http://localhost:8080/jsp_basic/jsp015_checkbox.jsp?username=sally&option1=cat&option1=pig -->
	...
	<div class="container card my-5">
		...
		<script>
			function check2(){
				...
				let optradio = document.querySelectorAll(".form-check-input1:checked");
				//Q3. :checked 넣어서 갯수 확인
				// console.log(optradio.length);
				
				//Q4. #username1 빈칸이면 알림창, 커서 가게
				if(username1.value == "") {alert("빈칸입니다."); username1.focus(); return false;}
				//Q5. radio 체크가 0개라면 알림창
				if(optradio.length == 0) {alert("체크해주세요."); return false;}
			}
		</script>
	</div>
	...
	<div class="container card my-5">
		...
		<script>
			function check3() {
				...
				// console.log(color.velue);
				
				if(username3.value == "") {alert("빈칸입니다."); username3.focus(); return false;}
				if(color.value == "") {alert("빈칸입니다."); color.focus(); return false;}
			}
		</script>
	</div>
</body>
