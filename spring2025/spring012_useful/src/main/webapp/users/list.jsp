...
<body>
	...
	<!-- update -->
	<div class="container card my-3">
		<form method="post" action="update.user" id="userUpdate" onsubmit="return form()">
			<fieldset>
				<legend>유저수정폼</legend>
				<div class="form-group">
					<label for="no_u">번호</label> <input type="text" name="no"
						id="no_u" class="form-control" />
				</div>
				<div class="form-group">
					<label for="name_u">이름</label> <input type="text" name="name"
						id="name_u" class="form-control" />
				</div>
				<div class="form-group">
					<label for="age_u">나이</label> <input type="number" name="age"
