...
<div class="container"  style="margin-top:5%; min-height:500px">
		<h3>MULTIBOARD 삭제</h3>
		<form action="${pageContext.request.contextPath}/board/delete" method="post"   id="deleteForm"> 
			<div class="form-group">
			  <label for="bno" >번호</label>
			  <input type="text" name="bno" id="bno" value="${param.bno}" class="form-control" readonly > 
