...
import com.thejoa.project001.member.MemberService;
import com.thejoa.project001.util.PagingDto;
...
public class BoardController {
	...
	public String insert_post(Model model, RedirectAttributes rttr,MultipartFile file, Principal principal , @Valid BoardForm boardForm , BindingResult bindingResult) { 
	...
	public String update_get(Principal principal, Model model) { return "board/update"; }
