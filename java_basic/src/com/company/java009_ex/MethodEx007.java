...
public class MethodEx007 {
	...
	public static void who_are_you(String [][] users) { // 아이디를입력받아서 나라조회 
		...
		//처리
		// if(입력받은 id가 "aaa"와 같니){ aaa는 한국사람입니다.}
		// if(입력받은 id가 "bbb"와 같니){ bbb는 호주사람입니다.}
		// if(입력받은 id가 "ccc"와 같니){ ccc는 중국사람입니다.}
	...
	public static void who_pass_change(String [][] users){ // 아이디,비밀번호가 맞으면 비밀번호 바꾸기
		...
		//처리
		// 1)사용자 인증1 - if(입력받은 아이디와 "aaa" / 입력받은 비번과 "111"이 같다면){ 해당유저의 층확인}
