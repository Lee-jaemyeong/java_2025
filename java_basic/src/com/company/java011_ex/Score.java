...
//멤버함수
	...
	public Score(String name, int kor, int eng, int math) {
		...
		this(); // Score()
		this.name = name; this.kor = kor; this.eng = eng; this.math = math; // 사용자들에게 입력받은다음에셋팅
		//1-2. this();  // error Score()
		} // 1. new 메모리,객체생성 2. Score() 초기화 3.a1번지
	
	@Override public String toString() { return "Score [name=" + name + ", kor=" + kor + ", eng=" + eng + ", math=" + math + ", total=" + total
