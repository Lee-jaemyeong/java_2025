...
public class Lambda004_api {
	public static void main(String[] args) {
		...
		//2. (t)->{return}  파라미터 O / 리턴값 O  유무
		// IntBinaryOperator operater = (left,right)->{return left>=right? left:right;};
		// IntBinaryOperator operater = (left,right)-> left>=right? left:right;
		// IntBinaryOperator operater = (left,right)-> Math.max(left, right);
		IntBinaryOperator operater =  Math::max;
		System.out.println(operater.applyAsInt(10, 3)); // 10 큰값리턴
	}
}
/*
2. 자바 api의 함수형 인터페이스
