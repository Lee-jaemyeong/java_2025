...
public class Arr001 {
	public static void main(String[] args) {
		...
		System.out.print(arr6[2]); // 'c'  32~34번째줄 for문으로 표현 도전!
		System.out.println();
